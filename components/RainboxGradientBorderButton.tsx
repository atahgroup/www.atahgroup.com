...
export const RainboxGradientBorderButton = ({
  ...
  return (
    <button
      className="w-full relative group overflow-hidden rounded-full p-[3px] focus:outline-none"
      onClick={onClick}
    >
      ...
      <div className="relative z-10 flex items-center justify-center bg-gradient-to-r from-[#D8E7FF] via-[#D6F2FF] to-[#D2F6F4] dark:from-[#2F4B68] dark:via-[#2D5068] dark:to-[#2C5263] px-8 py-3 rounded-full text-foreground transition-all group-hover:bg-white/80 group-hover:underline underline-offset-4 cursor-pointer">
        {children}
      </div>
    </button>
  );
